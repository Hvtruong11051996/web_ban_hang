...
if (isset($_POST["btnLogin"])) {
    ...
    if ($username === '' || $password === '') {
        ...
        $sql = "SELECT * FROM dangky_kh WHERE username = '$username' AND password = '$password'";
                    ...
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                ...
                                <span style="color: #288ad6;">Đăng Nhập </span>
                            </h1>
                        </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <button name="btnLogin" type="submit"
                                                        class="width-35 pull-right btn width-35 pull-right btn btn-sm btn-primary">
                                                        Login
                                                    </button>
